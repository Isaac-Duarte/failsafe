//! GPU-backed screen viewer for Windows.
//! macOS and Linux use the webview JPEG fallback because wgpu + transparent
//! compositing is unreliable there and conflicts with tauri-build feature checks.
